...
//    j++;
    ...
    i++;
    CGPoint cPoints[2];
    cPoints[0]=CGPointMake(0, 195);
    cPoints[1]=CGPointMake(300,195);
    CGContextAddLines(context, cPoints, 2);
    CGContextDrawPath(context, kCGPathStroke);
    //中间画一根横线线条
    CGPoint dPoints[2];
    dPoints[0]=CGPointMake(0, 375);
    dPoints[1]=CGPointMake(300,375);
    CGContextAddLines(context, dPoints, 2);
    CGContextDrawPath(context, kCGPathStroke);
    //中间画一根树直线
    CGContextSetStrokeColorWithColor(context, [UIColor blueColor].CGColor);
    CGPoint ePoints[2];
    ePoints[0]=CGPointMake(149, 15);
    ePoints[1]=CGPointMake(149,375);
